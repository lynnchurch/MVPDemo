...
public class DrawableProvider {
    ...
    /**
     * 将radiobutton的drawable按比例缩放
     *
     * @param percent
     * @param rb
     * @return
     */
    public static Drawable getScaleDrawableByPercentForRadioButton(float percent, TextView rb) {
    ...
    /**
     * 将radiobutton的drawable按宽度缩放
     *
     * @param rb
     * @return
     */
    public static Drawable getScaleDrawableByWidthForRadioButton(float width, TextView rb) {
        Drawable[] compoundDrawables = rb.getCompoundDrawables();
        Drawable drawable = null;
        for (Drawable d : compoundDrawables) {
            if (d != null) {
     ...
     * @return
     */
    public static Drawable getScaleDrawableByPercent(float percent, Drawable drawable) {
        drawable.setBounds(0, 0, (int) (drawable.getIntrinsicWidth() * percent + 0.5f), (int) (drawable.getIntrinsicHeight() * percent + 0.5f));
        return drawable;
    }
     ...
     * @return
     */
    public static Drawable getScaleDrawableByWidth(float width, Drawable drawable) {
        float percent = width * 1.0f / drawable.getIntrinsicWidth();
        drawable.setBounds(0, 0, (int) (drawable.getIntrinsicWidth() * percent + 0.5f), (int) (drawable.getIntrinsicHeight() * percent + 0.5f));
        return drawable;
    }
